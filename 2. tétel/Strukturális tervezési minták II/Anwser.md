...
## 2. kérdés: Mutassa be a Facade tervezési mintát!
![alt text](facade2.png)
![alt text](facade1.png)

## 3. kérdés: Mutassa be a Flyweight (I-II-III.) tervezési mintákat!

### FLYWEIGHT I.

![alt text](flyweightI-1.png)
![alt text](flyweightI-2.png)

### FLYWEIGHT II.

![alt text](flyweightII-1.png)
![alt text](flyweightII-2.png)
